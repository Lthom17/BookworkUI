        ...
        <nav className="w-full mx-auto  px-4 sm:px-20 fixed top-0 z-50 shadow blue lighten-2 ">
            <div className="justify-between md:items-center md:flex">
                ...
                <div className='fixed top-0 mx-auto'>
                    <a href="/" className="brand-logo" ><img src={logo} className="brand-logo-img" alt=""></img></a>
                </div>
                <ul id="nav-mobile" className="right hide-on-med-and-down align-wrapper">
                    <li>
                    ...
                    {user ? (
                        <>
                            ...
                            <li><Link to="/" onClick={logout}>Logout: {user.user.sub}</Link></li>
                        </>
                    ) : (
                        <>
